...
### 以类 + 方法扼要说明
   ...
   ```html
new ClassPathXmlApplicationContext # <b>构造方法</b>
		AbstractApplicationContext # <b>refresh</b> 刷新 Spring IoC 容器（删除原容器，创建新容器）
				obtainFreshBeanFactory 创建工厂并初始化，<b>以下为 BeanFactory 具体流程</b>
						AbstractRefreshableApplicationContext # <b>refreshBeanFactory</b> 创建 										  		
						        DeafaultListableBeanFactory
```
