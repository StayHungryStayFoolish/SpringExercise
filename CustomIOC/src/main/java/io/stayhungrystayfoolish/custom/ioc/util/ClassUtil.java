...
/**
 * @Author: Created by bonismo@hotmail.com on 2019-10-16 14:05
 * @Description: 查找指定路径 class
 * @Version: 1.0
 */
public class ClassUtil {
    ...
    private static List<String> getAllClassNameByFile(File file, boolean flag) {
        ...
        if (file.isFile()) {
            ...
            // 注意：这里替换文件分割符要用 replace。因为 replaceAll 里面的参数是正则表达式,而 windows 环境中 File.separator="\\"的,因此会有问题
