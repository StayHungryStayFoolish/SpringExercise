...
---
   ...
   a. 存储解析的 xml 信息 **Map<String, BeanDefinition>** 其中 **BeanDefinition** 封装了 xml 中 *'<bean'>* 标签信息
   
   b. 存储 bean 的实例 **Map<String, Object> singletonBeanMap**
...
- **参考文章**：
 ...
 2. BeanDefinition（Bean 装备信息）
 
 3. ApplicationContext（Bean 工厂入口）
